...
using System;
using Bodoconsult.Database.DataTableBackup;
...
{
    [TestFixture]
    internal class CsvDataTableBackupServiceTests
    {
        ...
        {
            // Arrange 
            var dataService = new DemoDataTableBackupDataService();

            // Act  
            var backupService = new CsvDataTableBackupService(dataService, FileHelper.EntityBackupPath, "TestBackup");
        ...
        public void Backup_ValidSetup_FileCreated()
        {
            ...
            var dataService = new DemoDataTableBackupDataService();
            TestHelper.GetDataTableForService(dataService.Data, from, to);
            ...
            // Assert
            Assert.That(backupService.FilesWritten, Is.EqualTo(3));
        }
