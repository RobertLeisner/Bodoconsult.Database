...
/// <summary>
/// Base class for <see cref="IDataTableBackupService"/> implementations
/// </summary>
public abstract class BaseDataTableBackupService : IDataTableBackupService
{
    /// <summary>
    ///  Default ctor
    /// </summary>
    /// <param name="formatter"></param>
    protected BaseDataTableBackupService(IDataTableBackupFormatter formatter)
    {
        Formatter = formatter;
    }
    ...
    /// </summary>
    public IDataTableBackupDataService DataService { get; protected set; }

    /// <summary>
    /// Current formatter to use
    /// </summary>
    public IDataTableBackupFormatter Formatter { get; }
    ...
    public virtual int Backup(DateTime from, DateTime to, int pageIndex, string fileName)
    {
        ...
        return count == PageSize ? PageSize : 0;
    }
