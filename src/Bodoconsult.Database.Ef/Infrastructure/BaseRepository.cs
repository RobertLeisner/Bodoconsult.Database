...
#pragma warning disable CA1724
    ...
    /// <summary>
    /// Base generic repository for all POCO types implementing IEntityRequirements
    /// </summary>
    /// <typeparam name="TEntity">POCO type of the repository</typeparam>
    /// <typeparam name="TContext"></typeparam>
    public class BaseRepository<TEntity, TContext> : IRepository<TEntity> where TEntity : class, IEntityRequirements, new() where TContext : DbContext
    {
        ...
        public BaseRepository(IAmbientDbContextLocator contextLocator, IAppLoggerProxy logger)
        {
        ...
        public TEntity AddOrUpdate(TEntity entity)
        {
            ...
            return entity.ID < 1 ? AddInternal(entity) : Update(entity);
        }
        ...
        public void DropAll()
        {
            ...
            // There here throws an exception one reason maybe not valid field contents in the entity (null for bool etc)
        ...
        public IEnumerable<string> GetIncludePaths()
        {
            ...
            _includePaths = InternalGetIncludePaths();
            return _includePaths;
        }
        ...
        /// </summary>
        /// <returns>all include paths</returns>
        public IEnumerable<string> InternalGetIncludePaths()
        {
            var db = _contextLocator.GetContext<TContext>();
            ...
            {
                throw new Exception(
                    "No DB context available. Did you use GetContextScope() or GetReadOnlyContextScope?");
            }
