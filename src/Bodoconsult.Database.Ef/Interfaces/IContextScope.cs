...
namespace Bodoconsult.Database.Ef.Interfaces
{
    ...
    public interface IContextScope : IDisposable
    {
        ...
        /// This method can only be called once per scope.
        /// </summary>
        int SaveChanges(ConcurrencyConflictSolvingType concurrencyConflictSolvingType);
        ...
        /// This method can only be called once per scope.
        /// </summary>
        Task<int> SaveChangesAsync(ConcurrencyConflictSolvingType concurrencyConflictSolvingType);
        ...
        /// This method can only be called once per scope.
        /// </summary>
        Task<int> SaveChangesAsync(CancellationToken cancelToken, ConcurrencyConflictSolvingType concurrencyConflictSolvingType);
