...
{
    /// <summary>
    /// Interface for data repositories with uniqueidentifier ID column
    /// </summary>
    /// <typeparam name="TEntity">Entity type with uniqueidentifier ID column</typeparam>
    public interface IRepositoryGuid<TEntity> where TEntity : class, IEntityRequirementsGuid, new()
    {
