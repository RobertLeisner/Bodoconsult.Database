...
Bodoconsult.Database library simplifies the access to SQL based databases using System.Data classes like DataTable, DataReader etc.. This library is a base class which does not contain implementations. 
...
See the following implementations for specific database systems:

>   **[Bodoconsult.Database.SqlClient](../Bodoconsult.Database.SqlClient/README.md)** for Microsoft SqlServer, Microsoft SqlServer Express or LocalDb based databases (Nuget: <https://www.nuget.org/packages/Bodoconsult.Database.SqlClient/>)

>   **[Bodoconsult.Database.Postgres](doc/Bodoconsult.Database.Postgres/README.md)** for PostgreSQL based databases (Nuget: <https://www.nuget.org/packages/Bodoconsult.Database.Postgres/>)

>   **[Bodoconsult.Database.Sqlite](doc/Bodoconsult.Database.Sqlite/README.md)** for SqLite based databases (Nuget: <https://www.nuget.org/packages/Bodoconsult.Database.Sqlite/>)
...
``` csharp
        ...
        public void Backup_ValidSetup_FileCreated()
        {
            ...
            var backupService = new CsvEntityBackupService<DemoEntity>(dataService, FileHelper.EntityBackupPath, "TestBackup");
...
This feature works only well for statements based on a single table. If there are more tables targeted in the statement, only the GetAll and GetById may make sense in the service class. 
...
SqlRunnerService is a helper class to run SQL statements in an ordered on always the same thread.
